...
- **Daily.co**: Video call infrastructure (Privacy Policy: daily.co/legal/privacy)
- **Expo**: App infrastructure (Privacy Policy: expo.dev/privacy)

## Children's Privacy

Psychi is not intended for users under 18 years of age. We do not knowingly collect personal information from children under 18. If we become aware that we have collected data from a child under 18, we will take steps to delete such information.
...
If you access Psychi from outside the United States, your data may be transferred to and processed in the United States. By using our services, you consent to this transfer.

## Changes to This Policy

We may update this Privacy Policy periodically. We will notify you of material changes through the app or via email. Continued use of Psychi after changes constitutes acceptance of the updated policy.
...
In cases where there is an imminent risk of harm to yourself or others, we may share limited information with emergency services to ensure safety. This is consistent with our commitment to user wellbeing.
