-- Migration: Fix accept_live_support_request to create a session
-- Issue: The function was accepting the request but not creating a session,
-- causing "session not found" errors when trying to join the session.
